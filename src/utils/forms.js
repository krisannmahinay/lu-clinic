...
export const generateInfoForms = (data, province, municipality, barangay /*icd10code*/) => {
    ...
    return [
        ...
        {name: 'birth_date', type: 'date', label: 'Birthdate'},
        {name: 'birth_place', type: 'text', label: 'Birth Place', placeholder: 'Type...'},
        {
            name: 'gender',
            type: 'dropdown',
            label: 'Gender',
        ...
        {name: 'no_blk_lot', type: 'number', label: 'No/Blk/Lot', placeholder: 'Type...'},
        {name: 'nationality', type: 'text', label: 'Nationality', placeholder: 'Type...'},
        {name: 'religion', type: 'text', label: 'Religion', placeholder: 'Type...'},
        // employer details
        ...
        // family details
        {name: 'father_name', type: 'text', label: 'Father Name', placeholder: 'Type...'},
        {name: 'father_address', type: 'text', label: 'Father Address', placeholder: 'Type...'},
        {name: 'father_contact', type: 'text', label: 'Father Contact', placeholder: 'Type...'},
        {name: 'mother_name', type: 'text', label: 'Mother Name', placeholder: 'Type...'},
        {name: 'mother_address', type: 'text', label: 'Mother Address', placeholder: 'Type...'},
        {name: 'mother_contact', type: 'text', label: 'Mother Contact', placeholder: 'Type...'},
        {name: 'spouse_name', type: 'text', label: 'Spouse Name', placeholder: 'Type...'},
        {name: 'spouse_address', type: 'text', label: 'Spouse Address', placeholder: 'Type...'},
        {name: 'spouse_contact', type: 'text', label: 'Spouse Contact', placeholder: 'Type...'},

        // patient details
        {name: 'admission_date', type: 'date', label: 'Admission Date | Time'},
        {name: 'discharge_date', type: 'date', label: 'Discharge Date | Time'},
        {name: 'total_no_day', type: 'text', label: 'Total No of Day', disabled: true},
        {name: 'admitting_physician', type: 'text', label: 'Admitting Physician', disabled: true},
        {name: 'admitting_clerk', type: 'text', label: 'Admitting Clerk', disabled: true},
        {name: 'type_visit', type: 'text', label: 'Type of Admission', disabled: true},
        {name: 'referred_by', type: 'text', label: 'Referred By (Physician/Health Facility)', placeholder: 'Type...'},
        {name: 'soc_serv_classification', type: 'checkbox', category: 'socserv', label: 'Social Service Classification'},
        {name: 'allergic_to', type: 'text', label: 'Allergic To', placeholder: 'Type..'},
        {name: 'hospitalization_plan', type: 'text', label: 'Hospitalization Plan', placeholder: 'Type..'},
        {name: 'health_insurance_name', type: 'text', label: 'Health Insurance Name', placeholder: 'Type..'},
        {name: 'phic', type: 'checkbox', category: 'phic', label: 'PHIC'},
        {name: 'data_furnished_by', type: 'text', label: 'Data Furnished By', disabled: true},
        {name: 'address_of_informant', type: 'text', label: 'Address of Informant', placeholder: 'Type..'},
        {name: 'relation_to_patient', type: 'text', label: 'Relation to Patient', placeholder: 'Type..'},
