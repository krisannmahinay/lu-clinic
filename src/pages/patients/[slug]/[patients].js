                    ...
                    <div className="flex items-center">
                        <div className="-space-y-5">
                            <div className="items-center">
                                <div className="font-bold text-xl mb-2 uppercase text-gray-600">{slug}</div>
                            </div>
                            <div className="items-center">
                                <svg className="h-5 w-5 text-gray-500" viewBox="0 0 24 24"> {/* <-- Placeholder icon for birthday */}
                                </svg>
                            ...
                            <div className="items-center">
                                <svg className="h-5 w-5 text-gray-500" viewBox="0 0 24 24"> {/* <-- Placeholder icon for location */}
                                </svg>
                        ...
                        <div className="bg-white overflow-hidden mx-auto sm:w-full">
                            <div className="border border-gray-300 rounded">
                                <div className="flex justify-items-center">
                                    <div className="rounded-tl-lg py-3 ml-3">
                                        <button 
                                            ...
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab1' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Patient Information and consent
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab2')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab2' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>S.O.A.P
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab3')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab3' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Laboratory Results
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab4')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab4' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Imaging Results
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab5')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab5' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Prescription
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="tab-content px-3 max-h-[65vh] overflow-y-auto scroll-custom">
                                    {activeTab === 'tab1' && (
                                        <PatientInformation opdForms={true}/>
                                    )}
                                    {activeTab === 'tab2' && (
                                    ...
                                    {activeTab === 'tab4' && (
                                        <>
                                            <ImagingResult slug={slug} imageType="XRAY" data={imagingResults}/>
                                        </>
                                    )}
                                    {activeTab === 'tab5' && (
                                        <div>
                            ...
                            <div className="border rounded-lg ">
                                <div className="flex justify-items-center">
                                    <div className="rounded-tl-lg py-3 ml-3">
                                        <button 
                                            onClick={() => setActiveTab('tab1')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab1' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Patient Information & Consent
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab2')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab2' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Medical History
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab3')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab3' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Laboratory Results
                                        ...
                                        <button 
                                            onClick={() => setActiveTab('tab5')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab5' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Doctor's Orders
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab6')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab6' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Monitoring Sheets
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab7')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab7' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Nurse's Notes
                                        </button>
                                        <button 
                                            onClick={() => setActiveTab('tab8')}
                                            className={`focus:outline-none font-medium uppercase text-sm text-gray-500  ${activeTab === 'tab8' ? 'bg-gray-200 rounded-md p-4':'bg-white rounded-md p-4'}`}>Medication Sheet
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="tab-content px-3 max-h-[70vh] overflow-y-auto scroll-custom">
                                    {activeTab === 'tab1' && (
                                        <div>
                                            <PatientInformation ipdForms={true}/>
                                        </div>
                                    )}
                                    {activeTab === 'tab2' && (
                                        <div>
                                        ...
                                        <>
                                            <div className="flex flex-col gap-4 mb-2 sm:flex-row">
                                                <div className="flex flex-col w-[10rem]">
                                                    <button className="bg-green-500 hover:bg-green-600 text-white p-4 rounded mr-2" onClick={handleAddData}>Add Data</button>
                                                </div>

                                                <div className="flex flex-col w-[10rem]">
                                                    <button className="bg-red-500 hover:bg-red-600 text-white p-4 rounded mr-2" onClick={handleClearData}>Clear Data</button>
                                                </div>
                                            </div>
