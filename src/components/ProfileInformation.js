        ...
        <div className="bg-gray-100 p-8 pt-[5rem]">
            <div className="flex gap-6">
                <div className="flex-none w-2/5 p-6 bg-white shadow-lg rounded-lg">
                    ...
                    <div className="mt-8">
                        <h4 className="text-lg font-semibold text-gray-700 mb-4 cursor-pointer">Profile Information</h4>
                        <div className="flex items-center text-gray-600 mb-4">
                            <svg className="h-6 w-6 mr-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div className="flex items-center text-gray-600 mb-4">
                            <svg className="h-6 w-6 mr-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 00.948-.684l1.516-4.55A1 1 0 0110.22 1h3.56a1 1 0 01.948 1.266l-1.516 4.55a1 1 0 00.948 1.316H19a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path>
