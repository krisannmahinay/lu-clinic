...
const ClinicalRecord = () => {
    ...
    const cr_heent = componentContext?.state?.profileData?.cr_heent?.split(',') || []
    const cr_chest_lungs = componentContext?.state?.profileData?.cr_chest_lungs?.split(',') || []
    const cr_cvs = componentContext?.state?.profileData?.cr_cvs?.split(',') || []
    const cr_neurological_exam = componentContext?.state?.profileData?.cr_neurological_exam?.split(',') || []
    ...
    const getSelectedHeentData = () => {
        return heentChecks.filter((item) => item.checked).map((item) => item.code)
    }

    const getSelectedChestLungData = () => {
        return chestLungChecks.filter((item) => item.checked).map((item) => item.code)
    }

    const getSelectedCvsData = () => {
        return cvsChecks.filter((item) => item.checked).map((item) => item.code)
    }

    const getSelectedNeuronData = () => {
        return neuronChecks.filter((item) => item.checked).map((item) => item.code)
    }
    ...
    const handleBlur = (data) => {
        switch(data.type) {
            case 'clinical_record':
                ...
                break
            case 'heent':
                componentContext?.onAutoSave({type:'updatePatientHeent', value:getSelectedHeentData()})
                break
            case 'chest_lungs':
                componentContext?.onAutoSave({type:'updatePatientChestLung', value:getSelectedChestLungData()})
                break
            case 'cvs':
                componentContext?.onAutoSave({type:'updatePatientCvs', value:getSelectedCvsData()})
                break
            case 'neuron':
                componentContext?.onAutoSave({type:'updatePatientNeuron', value:getSelectedNeuronData()})
                break
            default:
                break
        }
    ...
    return (
        <div>
            ...
            <div className="xl:ml-[25rem] xl:mr-[25rem] lg:pl-0 lg:pr-0 md:pl-0 md:pr-0 sm:pl-0 sm:pr-0 space-y-5">
                <div className="grid grid-cols-1">
                    ...
                    <input
                        ...
                        onChange={(e) => handleOnChange({type:"cr_chief_complain", value: e.target.value})}
                ...
                <div className="grid grid-cols-1">
                    <label className=" text-gray-500 font-medium text-sm">History of Present Illness: </label>
                    <textarea
                        type="text"
                ...
                <div className="grid grid-cols-1">
                    <label className=" text-gray-500 font-medium text-sm">OB/GYN History: </label>
                    <input
                        type="text"
                        name="cr_ob_history"
                        value={formData.cr_ob_history || patientData?.cr_ob_history}
                        onChange={(e) => handleOnChange({type:"cr_ob_history", value: e.target.value})}
                        onBlur={() => handleBlur({type: 'clinical_record'})}
                        className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                ...
                <div className="grid grid-cols-1">
                    ...
                    <input
                        ...
                        value={formData.cr_past_med_history || patientData?.cr_past_med_history}
                        onChange={(e) => handleOnChange({type:"cr_past_med_history", value: e.target.value})}
                        onBlur={() => handleBlur({type: 'clinical_record'})}
                        className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                        placeholder="Type..."
                    />
                ...
                <div className="grid grid-cols-1">
                    ...
                    <input
                        ...
                        value={formData.cr_personal_soc_history || patientData?.cr_personal_soc_history}
                        onChange={(e) => handleOnChange({type:"cr_personal_soc_history", value: e.target.value})}
                        onBlur={() => handleBlur({type: 'clinical_record'})}
                        className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                        placeholder="Type..."
                    />
                ...
                <div className="grid grid-cols-1">
                    ...
                    <input
                        ...
                        onChange={(e) => handleOnChange({type:"cr_family_history", value: e.target.value})}
                        onBlur={() => handleBlur({type: 'clinical_record'})}
                        className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                        placeholder="Type..."
                    />
            ...
            <div className="xl:ml-[25rem] xl:mr-[25rem] lg:pl-0 lg:pr-0 md:pl-0 md:pr-0 sm:pl-0 sm:pr-0 space-y-5">
                        ...
                        {['awake_alert', 'altered_sensorium'].map((service, index) => (
                            <div className="flex items-center space-x-1">
                                <input
                                    ...
                                    checked={service === generalSurveyTickbox || service === patientData?.cr_general_survey}
                                    onChange={(e) => handleOnChange({type:"cr_general_survey", event: e.target.checked, value:service})}
                                    onBlur={() => handleBlur({type: 'clinical_record'})}
                                    className="w-5 h-5"
                                    />
                ...
                <div className="grid grid-cols-1">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center">
                            <label className=" text-gray-500 font-medium text-sm mr-3 w-24">BP: </label>
                            <input
                                type="text"
                                name="vital_bp"
                                value={formData.vital_bp || patientData?.vital_bp}
                                onChange={(e) => handleOnChange({type:"vital_bp", value: e.target.value})}
                                onBlur={() => handleBlur({type: 'clinical_record'})}
                                className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                        ...
                        <div className="flex items-center">
                            <label className=" text-gray-500 font-medium text-sm mr-3 w-24">HR: </label>
                            <input
                                type="text"
                                name="vital_hr"
                                value={formData.vital_hr || patientData?.vital_hr}
                                onChange={(e) => handleOnChange({type:"vital_hr", value: e.target.value})}
                                onBlur={() => handleBlur({type: 'clinical_record'})}
                                className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                        ...
                        <div className="flex items-center">
                            <label className=" text-gray-500 font-medium text-sm mr-3 w-24">Temp: </label>
                            <input
                                type="text"
                                name="vital_temp"
                                value={formData.vital_temp || patientData?.vital_temp}
                                onChange={(e) => handleOnChange({type:"vital_temp", value: e.target.value})}
                                onBlur={() => handleBlur({type: 'clinical_record'})}
                                className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                        ...
                        <div className="flex items-center">
                            <label className=" text-gray-500 font-medium text-sm mr-3 w-24">O2 Sat: </label>
                            <input
                                type="text"
                                name="vital_o2sat"
                                value={formData.vital_o2sat || patientData?.vital_o2sat}
                                onChange={(e) => handleOnChange({type:"vital_o2sat", value: e.target.value})}
                                onBlur={() => handleBlur({type: 'clinical_record'})}
                                className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                                placeholder="SpO2 (%)"
                            />
                        ...
                        <div className="flex items-center">
                            <label className=" text-gray-500 font-medium text-sm mr-3 w-24">Height: </label>
                            <input
                                type="text"
                                name="vital_height"
                                value={formData.vital_height || patientData?.vital_height}
                                onChange={(e) => handleOnChange({type:"vital_height", value: e.target.value})}
                                onBlur={() => handleBlur({type: 'clinical_record'})}
                                className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                                placeholder="(cm)"
                            />
                        ...
                        <div className="flex items-center">
                            <label className=" text-gray-500 font-medium text-sm mr-3 w-24">Weight: </label>
                            <input
                                type="text"
                                name="vital_weight"
                                value={formData.vital_weight || patientData?.vital_weight}
                                onChange={(e) => handleOnChange({type:"vital_weight", value: e.target.value})}
                                onBlur={() => handleBlur({type: 'clinical_record'})}
                                className="border border-gray-300 bg-gray-100 text-sm w-full px-3 py-2 focus:outline-none focus:border-gray-500"
                                placeholder="(kg)"
                            />
                        ...
                        {heentData.map(item => (
                            <div className="flex items-center space-x-1">
                                <input
                                    ...
                                    type="checkbox"
                                    name="heent"
                                    checked={heentChecks.find((data) => data.code === item.code).checked}
                                    onChange={(e) => handleCheckboxChange({type: 'heent', event: e, item:item})}
                                    onBlur={() => handleBlur({type: 'heent'})}
                                    className="w-5 h-5"
                                    />
                                <label className="text-gray-500 font-bold text-xs capitalize">{item.name} </label>  
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1">
                    <label className=" text-gray-500 font-medium text-sm">CHEST/LUNGS: </label>
                    <div className="flex flex-col space-y-2 w-3/5">
                        {chestLungsData.map(item => (
                            <div className="flex items-center space-x-1">
                                <input
                                    ...
                                    type="checkbox"
                                    name="chest_lungs"
                                    checked={chestLungChecks.find((data) => data.code === item.code).checked}
                                    onChange={(e) => handleCheckboxChange({type: 'chest_lungs', event: e, item:item})}
                        ...
                        {cvsData.map(item => (
                            <div className="flex items-center space-x-1">
                                <input
                                    ...
                                    type="checkbox"
                                    name="cvs"
                                    checked={cvsChecks.find((data) => data.code === item.code).checked}
                                    onChange={(e) => handleCheckboxChange({type: 'cvs', event: e, item:item})}
                ...
                <div className="grid grid-cols-1">
                    <label className=" text-gray-500 font-medium text-sm">NEUROLOGICAL EXAMINATION: </label>
                    <div className="flex flex-col space-y-2 w-3/5">
                        {neuronData.map(item => (
                            <div className="flex items-center space-x-1">
                                <input
                                    ...
                                    checked={neuronChecks.find((data) => data.code === item.code).checked}
                                    onChange={(e) => handleCheckboxChange({type: 'neurological_exam', event: e, item:item})}
